...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // endpoints.addEndpoint("2", "CO2 sensor", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonDioxide);
    var endpoint1 = endpoints.addEndpoint("1", "Evaporation Rate", endpointType.genericSensor);
    endpoint1.variableTypeId = 1367;
    
    var endpoint2 = endpoints.addEndpoint("2", "Water Weight", endpointType.genericSensor);
    endpoint2.variableTypeId = 1369;

    var endpoint3 = endpoints.addEndpoint("3", "Water Height", endpointType.genericSensor);
    endpoint3.variableTypeId = 1369;
}
